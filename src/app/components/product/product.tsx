    ...
    <>
      ...
      >
        ...
        <div className={cn(styles.review)}>
          {product.reviewCount}{" "}
          {declensionWords(product?.reviewCount, [
            "отзыв",
            "отзыва",
            "отзывов",
          ])}
        ...
        <div className={cn(styles.actions)}>
          ...
          <Button
          onClick={onOpenRewiew}
            className={cn(styles.reviewBtn)}
            arrow={isOpenReview ? ARROW_BUTTON_POSITION.DOWN : 
            ARROW_BUTTON_POSITION.RIGHT}
      ...
      <Card color="purple" className={cn(styles.reviewWrapper, {
